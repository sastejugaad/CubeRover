...
<html>
  ...
  <body>
    <div class="container-fluid" style="background-color:#ED6E85;">
      <div class="col-xs-12"  style="height: 100vh">
        <div class="row" style="height: 33.33%; padding-top: 1em; padding-bottom:1em">
          ...
          <div class="col-xs-4" style="text-align: center; height: 100%">
            <button id="drive" type="button" class="btn btn-default" style="height: 100%; width: 100%" onmousedown='makeAjaxCall("forward")' onmouseup='makeAjaxCall("driveStop")' ontouchstart='makeAjaxCall("forward")' ontouchend='makeAjaxCall("driveStop")'>Forward</button>
          </div>
          
              <div class="speed-button-contianer" style="height:40; width: 50%; float: right" >
              <button id="drive" type="button" class="btn btn-default" style="height: 100%; width: 20%" onmousedown='makeAjaxCall("speed25")' onmouseup='makeAjaxCall("driveStop")' >25%</button>
              <button id="drive" type="button" class="btn btn-default" style="height: 100%; width: 20%" onmousedown='makeAjaxCall("speed50")' onmouseup='makeAjaxCall("driveStop")' >50%</button>
              <button id="drive" type="button" class="btn btn-default" style="height: 100%; width: 20%" onmousedown='makeAjaxCall("speed75")' onmouseup='makeAjaxCall("driveStop")' >70%</button>
              <button id="drive" type="button" class="btn btn-default" style="height: 100%; width: 20%" onmousedown='makeAjaxCall("speed100")' onmouseup='makeAjaxCall("driveStop")' >100%</button>
              </div>
